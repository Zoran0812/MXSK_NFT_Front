...
export const DEFAULT_CONTRACT_PROVIDER = new Web3.providers.HttpProvider(getHttpsRpcUrl());

const WEB3_ERROR_VALUE = 3.9638773911973445e+75;
// @ts-ignore: Unreachable code error
const web3 = new Web3(window.ethereum || DEFAULT_CONTRACT_PROVIDER);
...
class Web3Contract extends EventEmitter {
  ...
  send(method: string, methodArgs: any[] = [], sendArgs: Record<string, any> = {}, reload?: Function): Promise<any> {
